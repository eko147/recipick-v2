	...
	<main>
		<section class="mt-8 mb-8">
			<div class="container text-center">
				<!-- 아이콘 -->
				<div class="mb-4">
					<i class="feather-icon icon-alert-circle text-danger"
						style="font-size: 72px;"></i>
				</div>
				<!-- title -->
				<h1 class="fw-bold mb-4 text-danger">주문에 실패했습니다</h1>
				<p class="mb-5">
					주문 처리 중 문제가 발생했습니다. <br>
				</p>
				<!-- 버튼 -->
				<div class="d-flex justify-content-center">
					<a href="/shop-cart" class="btn btn-primary me-2">장바구니로 돌아가기</a>
				</div>
			</div>
		</section>
	</main>
